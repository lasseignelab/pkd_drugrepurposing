...
#options(ggrepel.max.overlaps = 50)
sp_deg_39 <- scatterPlot2(sim_deg_39$simMatrix, sim_deg_39$reducedTerms, labelSize = 2.5) + labs(title = "Cystic P21 Signature Enrichment Overview")
sp_deg_39
tm_deg_39 <- treemapPlot2(sim_deg_39$reducedTerms, title = "Enrichment for Cystic P21 Signature")
...
sp_deg_19 <- scatterPlot2(sim_deg_19$simMatrix, sim_deg_19$reducedTerms, labelSize = 2.5) + labs(title = "Cystic P21 Signature Enrichment Overview")
sp_deg_19
tm_deg_19 <- treemapPlot2(sim_deg_19$reducedTerms, title = "Enrichment for Cystic P21 Signature")
