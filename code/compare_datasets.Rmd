...
genebg <- read.csv2(file = "./data/background_genelist_genestoLINCSgenes.csv")
```
...
```{r}
fea_GSE69556 <- enrich(as.character(hom_56_UP$entrezgene_id), as.character(hom_56_DOWN$entrezgene_id), 30)#, filepath = "./res/fea/fea_GSE69556.pdf")
```
...
```{r}
fea_GSE134719 <- enrich(as.character(hom_19_UP$entrezgene_id), as.character(hom_19_DOWN$entrezgene_id), 30)#, filepath = "./res/fea/fea_GSE134719.pdf")
```
...
write.csv(fea_nf_GSE149739_upterms, file = "./res/fea/fea_nf_GSE149739_upterms.csv")

fea_nf_GSE149739_downterms <- apply(fea_nf_GSE149739$downregulated, 2, as.character)
write.csv(fea_nf_GSE149739_downterms, file = "./res/fea/fea_nf_GSE149739_downterms.csv")

##fea_GSE69556
fea_GSE69556_upterms <- apply(fea_GSE69556$upregulated, 2, as.character)
write.csv(fea_GSE69556_upterms, file = "./res/fea/fea_GSE69556_upterms.csv")

fea_GSE69556_downterms <- apply(fea_GSE69556$downregulated, 2, as.character)
write.csv(fea_GSE69556_downterms, file = "./res/fea/fea_GSE69556_downterms.csv")

##fea_GSE134719
fea_GSE134719_upterms <- apply(fea_GSE134719$upregulated, 2, as.character)
write.csv(fea_GSE134719_upterms, file = "./res/fea/fea_GSE134719_upterms.csv")

fea_GSE134719_downterms <- apply(fea_GSE134719$downregulated, 2, as.character)
write.csv(fea_GSE134719_downterms, file = "./res/fea/fea_GSE134719_downterms.csv")
```
...
'39 nf-core aligned
```{r}
musdegs_39_UP <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/deseq2_outputs/GSE149739_mus_degs_UP_220421.csv")

musdegs_39_DOWN <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/deseq2_outputs/GSE149739_mus_degs_DOWN_220421.csv")
```

'19
```{r}
musdegs_19_UP <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/deseq2_outputs/GSE134719_mus_degs_UP_220421.csv")
musdegs_19_DOWN <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/deseq2_outputs/GSE134719_mus_degs_DOWN_220421.csv")
```

'56
```{r}
musdegs_56_UP <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/deseq2_outputs/GSE69556_mus_degs_UP_220421.csv")

musdegs_56_DOWN <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/deseq2_outputs/GSE69556_mus_degs_DOWN_220421.csv")
```
...
### FEA p70 precystic '39 Mouse (nf-aligned)  
```{r}
fea_mouse_39 <- mouseenrich(musdegs_39_UP, musdegs_39_DOWN, 35)
...
fea_mouse_39$topcompared$term_name <- stringr::str_wrap(fea_mouse_39$topcompared$term_name, width = 70)
...
```{r}
ggsave(p70_fea_plot, filename = "./res/fea/p70_fea_plot.pdf")
```
...
Save plots
```{r}
ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mouse_39_overall.pdf", bp_mouse_39_overall)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/cilia_mouse_39_plot.pdf", cilia_mouse_39_plot)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mito_mouse_39_plot.pdf", mito_mouse_39_plot)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mouse_39_soce.pdf", mouse_39_soce)
...
bubbleplot(dplyr::filter(fea_mouse_56$topcompared, intersection_size > 10)) + labs(title = "Top Enriched Terms for Cystic P21 Dataset") + theme(text = element_text(size = 14), plot.title = element_text(size = 24))
```
...
Save plots
```{r}
ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mouse_56_overall.pdf", bp_mouse_56_overall)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/cilia_mouse_56_plot.pdf", cilia_mouse_56_plot)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mito_mouse_56_plot.pdf", mito_mouse_56_plot)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mouse_56_soce.pdf", mouse_56_soce)
...
bubbleplot(dplyr::filter(fea_mouse_19$topcompared, intersection_size > 10)) + labs(title = "Top Enriched Terms for Cystic P28 Dataset") + theme(text = element_text(size = 14), plot.title = element_text(size = 24))
```
...
write.csv(fea_mouse_39_upterms, file = "./res/fea/fea_mouse_39_upterms.csv")

fea_mouse_39_downterms <- apply(fea_mouse_39$downregulated, 2, as.character)
write.csv(fea_mouse_39_downterms, file = "./res/fea/fea_mouse_39_downterms.csv")

##fea_mouse_56
fea_mouse_56_upterms <- apply(fea_mouse_56$upregulated, 2, as.character)
write.csv(fea_mouse_56_upterms, file = "./res/fea/fea_mouse_56_upterms.csv")

fea_mouse_56_downterms <- apply(fea_mouse_56$downregulated, 2, as.character)
write.csv(fea_mouse_56_downterms, file = "./res/fea/fea_mouse_56_downterms.csv")

##fea_mouse_19
fea_mouse_19_upterms <- apply(fea_mouse_19$upregulated, 2, as.character)
write.csv(fea_mouse_19_upterms, file = "./res/fea/fea_mouse_19_upterms.csv")

fea_mouse_19_downterms <- apply(fea_mouse_19$downregulated, 2, as.character)
write.csv(fea_mouse_19_downterms, file = "./res/fea/fea_mouse_19_downterms.csv")
```

Save plots
```{r}
ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mouse_19_overall.pdf", bp_mouse_19)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/cilia_mouse_19_plot.pdf", cilia_mouse_19_plot)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mito_mouse_19_plot.pdf", mito_mouse_19_plot)

#ggsave(filename = "/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/mouse_19_soce.pdf", mouse_19_soce)
...
read in
```{r}
fea_56_up <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/fea_mouse_56_upterms.csv")

fea_56_down <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/fea_mouse_56_downterms.csv")

fea_19_up <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/fea_mouse_19_upterms.csv")

fea_19_down <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/fea_mouse_19_downterms.csv")

fea_39_up <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/fea_mouse_39_upterms.csv")

fea_39_down <- read.csv("/Users/eramsey/Downloads/kidney_drugrepurposing/pkd_drugrepurposing/res/fea/fea_mouse_39_downterms.csv")
```
...
```{r}
write.csv(fea_cystic_overlap_up, file = "./res/fea/fea_cystic_overlap_up.csv")

write.csv(fea_cystic_overlap_down, file = "./res/fea/fea_cystic_overlap_down.csv")

write.csv(fea_cystic_overlap_combined, file = "./res/fea/fea_cystic_overlap_combined.csv")
```
...
write.csv(fea_overlap_19_56_upterms, file = "./res/fea/fea_overlap_19_56_upterms.csv")

fea_overlap_19_56_downterms <- apply(fea_overlap_19_56_down, 2, as.character)
write.csv(fea_overlap_19_56_downterms, file = "./res/fea/fea_overlap_19_56_downterms.csv")

fea_overap_all_upterms <- apply(fea_overap_all_up, 2, as.character)
write.csv(fea_overap_all_upterms, file = "./res/fea/fea_overap_all_upterms.csv")

fea_overap_all_downterms <- apply(fea_overap_all_down, 2, as.character)
write.csv(fea_overap_all_downterms, file = "./res/fea/fea_overap_all_downterms.csv")
