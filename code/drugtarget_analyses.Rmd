...
```{r}
fda_approved_39 <- readRDS(here("res", "sigsearch_outputs", "p70_fdaapproved_drugs_copy.rds"))
...
write.csv(fda_approved_39_targets, file = here("res", "sigsearch_outputs", "fda_drug_targets_39_copy.csv"))
```
