...
```{r}
cts_p21 <- readRDS(here("data", "GSE695p21_salmonmerged_gene_counts.rds"))
...
meta_p21 <- read.csv(here("data", "GSE695p21_metadata.txt"), row.names = 1)
```
...
```{r}
cts_p28 <- readRDS(here("data", "GSE1347p28_salmonmerged_gene_counts.rds"))
meta_p28 <- read.csv(here("data", "GSE1347p28_metadata.txt"), row.names = 1)
```
