...
uplfc <- function(res){
  ...
  upfc <- res[res$log2FoldChange > 2.0 & res$padj < 0.05,]
...
downlfc <- function(res){
  ...
  res <- res[!is.na(res$padj),]
  #p-adjusted value cutoff 0.05 and log2fc greater than 2.0 and less than -2.0
  downfc <- res[res$log2FoldChange < -2.0 & res$padj < 0.05,]
...
write.csv(dsq2_56_up, file = here("res", "deseq2_outputs", "deseq2_upgenes_res_56.csv"))

write.csv(dsq2_56_down, file = here("res", "deseq2_outputs", "deseq2_downgenes_res_56.csv"))
```
...
write.csv(dsq2_19_up, file = here("res", "deseq2_outputs", "deseq2_upgenes_res_19.csv"))

write.csv(dsq2_19_down, file = here("res", "deseq2_outputs", "deseq2_downgenes_res_19.csv"))
```
