...
```{r}
targets_39 <- read.csv(here("res", "sigsearch_outputs", "fda_drug_targets_39.csv"), row.names = 1)
...
targets in > 1.5 LFC
```{r}
targets_in39 <- merge(fda_approved_39_targets, volc_39, by.x = "Target", by.y = "hgnc_symbol")
