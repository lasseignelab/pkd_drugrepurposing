...
```{r}
musdegs_39_UP <- uplfc(dsq2_39)
musdegs_39_DOWN <- downlfc(dsq2_39)
...
heatmap_p70 <- pheatmap(sig_39_cts[row.names(sig_39_cts), ], cluster_rows = TRUE, cluster_cols = TRUE, show_rownames = FALSE, color = viridis(n= 10000, alpha = 1, begin = 0, end = 1, option = "viridis"), border_color = "NA", main = "Gene Signature for Pre-Cyst P70", angle_col = 45)
...
musdegs_56_UP <- uplfc(dsq2_56)

musdegs_56_DOWN <- downlfc(dsq2_56)
```
...
#### LFC cutoffs
```{r}
musdegs_19_UP <- uplfc(dsq2_19)

musdegs_19_DOWN <- downlfc(dsq2_19)
```
...
heatmap_p28 <- pheatmap(sig_19_cts[row.names(sig_19_cts), ], cluster_rows = TRUE, cluster_cols = TRUE, show_rownames = FALSE, color = viridis(n= 10000, alpha = 1, begin = 0, end = 1, option = "viridis"), border_color = "NA", main = "Gene Signature for Pre-Cyst P70", angle_col = 45)
