...
top20lfc <- slice_max(genes, abs(log2FoldChange), n = 20)
```
...
top20lfc_56 <- slice_max(genes_56, abs(log2FoldChange), n = 20)
...
```{r eval=FALSE, include=FALSE}
ggsave(heatmap_21, filename = here("res", "fea", "heatmap_p21.pdf"), height = 7, width = 14)
...
top20lfc_19 <- slice_max(genes_19, abs(log2FoldChange), n = 20)
```
